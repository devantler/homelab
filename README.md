...
│   ├── renovate.json
│   ├── scripts
│   │   ├── e2e-debug-failure.sh
│   │   ├── e2e-verify-cluster-reconciliation.sh
...
│       │   ├── cluster-issuers
│       │   │   └── cloudflare-letsencrypt-cluster-issuer.yaml
│       │   ├── ingress
...
│               ├── repository.yaml
│               └── secrets
│                   └── basic-auth-user.yaml
├── scripts
│   ├── bootstrap-production.sh
│   └── talos-machine-configs
│       ├── .sops.yaml
│       ├── machine-config.talos-rpi-1.sops.yaml
│       ├── machine-config.talos-rpi-2.sops.yaml
│       └── machine-config.talos-rpi-3.sops.yaml
├── sops.public.asc
└── tree.bak
